...
function Dashboard() {
  ...
  const getPortfolio = async () => {
    try {
      ...
      setPortfolio({ ...data, skills: data.skills.join(",") });
  ...
  const deletePortfolio = async () => {
    try {
      await API.delete(`/portfolio/delete/${portfolio.email}`);
    ...
    <div className="container">
      ...
      <form onSubmit={createPortfolio}>
        ...
        <div className="button-group">
          ...
          <button type="button" onClick={getPortfolio}>Get</button>
          <button type="button" onClick={updatePortfolio}>Update</button>
          <button type="button" onClick={deletePortfolio}>Delete</button>
        </div>

        <div className="button-group">
          <Link to="/portfolio"><button type="button">Preview</button></Link>
